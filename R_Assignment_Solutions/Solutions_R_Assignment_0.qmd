...
In MTH 142 you will get lots of practice doing statistics through homework assignments, the final  and R Assignments. You will have 6  during this course that will help you do "modern" statistics with simulation and specialized R packages. In this R Assignment the goal is to warm up with some plotting and becoming familiar with R and quarto. You will have 7 questions at the end which will be graded. Finally you will know if you have done your R Assignment correctly if you are able to render without errors. (Getting errors is normal and common. If you are unable to fix them go to office hours or tutoring.) Turn in the rendered .pdf to moodle before the due date. Late R Assignments are not accepted and one will be dropped. Good luck.
...
`R` is an open-source programming language, meaning that users can contribute packages that make our lives easier, and we can use them for free. For this R Assignment, and many others in the future, we will use the following:
...
You have already opened R_Assignment_0.qmd and you are working in it now. In the future you can click File -\> Quarto Document to make a new .qmd file.
