...
I started falling asleep go back an rework this?
...
This is the point of R Assignment 2. If we could sample repeatedly from a population, the shape of all those samples would be normal.
...
We get 6.763449e-13 (0.0000000000006), which is much smaller than 0.05. 
We reject the null hypothesis and state that its very likely that a majority of students have been in more than one exclusive relationship. 
