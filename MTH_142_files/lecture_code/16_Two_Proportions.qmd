...
Sleep example
8.0%, while this proportion is 8.8% for Oregon residents. These data are based on simple random samples of 11,545 California and 4,691 Oregon residents

```{r}
p_1 = 0.08
p_2 = 0.088
#p_2-p_1
SE = sqrt(p_1*(1-p_1)/11545+p_2*(1-p_2)/4691)
#SE
...
days is 8.0%, while this proportion is 8.8% for Oregon residents. These data are based on simple random samples of 11,545 California and 4,691 Oregon residents.


```{r}
total_success = 0.08*11545 +0.088*4691

p_pool = total_success/(11545+4691)

SE = sqrt(p_pool*(1-p_pool)*(1/11545+1/4691))
#SE
...
2*pnorm(q = 0.008, mean = 0, sd = SE, lower.tail = FALSE)
