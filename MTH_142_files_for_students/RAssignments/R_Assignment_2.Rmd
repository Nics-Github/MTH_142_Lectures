...
It is my hope that you have a sense of the central limit theorem at this point. There are only 3 questions for this R Assignment. 

1. As the sample size increases the center of the sampling distribution gets closer to ___

2. As the sample size increases the variability ___

3. As the sample size increases the shape becomes  ____