...
1.  Would you expect the sample proportion to match the sample proportion of another student's sample?
    Why, or why not?
    Post to the forum to confirm your answer.
...
```{r iterate}
# Here was use a special operator called the pipe |>, which takes the output of the previous line and puts it as the argument of the next line. More on that in a later R Assignment
...
1.  How many elements are there in `sample_props50`? Describe the sampling distribution, and be sure to specifically note its center. Make sure to include a plot of the distribution in your answer. Post your answer to the forum to verify them. 
...
There are only 3 questions for this R Assignment. If you are stumped post your thoughts or questions to the discussion. 

1. As the sample size increases the center of the sampling distribution gets ____

2. As the sample size increases the variability of the sampling distribution ____

3. As the sample size increases the shape becomes ______